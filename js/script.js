...
const jackHannafordTranscript = [
  { start: -7, end: 6, text: "There was once a farmer and his wife. She had been married before, her first husband had died, and now she was married again." },
...
const endlessTaleTranscript = [
  { start: -7, end: 3, text: "In the Far East there was a Great King who had no work to do." },
...
const beanstalkTranscript = [
  { start: -7, end: 3, text: "Once upon a time there lived a poor widow and her son Jack." },
...
const boyFlewTooHighTranscript = [
  { start: -7, end: 6, text: "The underground paths housing the Minotaur beneath the isle of Crete were created by the dangerous and intelligent mind of Daedalus, an artist of design and construction." },
...
const bellOfAtriTranscript = [
  { start: -7, end: 4, text: "In the old Italian town of Atri, the King bought a fine, large bell and hung it in the marketplace tower." },
